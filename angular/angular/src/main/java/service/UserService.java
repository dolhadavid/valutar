...
public class UserService {
	...
	public User getUserByUsernameAndPassword(UserModel userModel) {
		return this.userDao.findUser(new User(userModel.getUsername(), userModel.getPassword()));
	}

	public List<String> getUsernameByCriteria(String criteria) {
		return this.userDao.getAllUsernameByCriteria(criteria);
	}
}
